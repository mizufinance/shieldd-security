...
def circuit (Input: F) (WasSquare: F) (InvSqrt: F) (OutX: F) (OutY: F): Prop :=
    ...
    canonicalFqBitsGadget gate_39 fun gate_50 =>
    ∃gate_51, gate_51 = Gates.sub gate_50[0] WasSquare ∧
    ∃gate_52, Gates.is_zero gate_51 gate_52 ∧
    ∃gate_53, gate_53 = Gates.neg gate_39 ∧
    ∃gate_54, Gates.select gate_52 gate_53 gate_39 gate_54 ∧
    ...
    ∃gate_63, Gates.inv gate_49 gate_63 ∧
