...
/-! Choice-free fixed-base RVK ladder semantics for normalized providers. -/

namespace Shieldd.GnarkFormal.RvkFixedBaseLadderChoiceFree
...
open Shieldd.GnarkFormal.RvkFixedBaseConstantsChoiceFree (C C_onCurve C_succ)
...
end Shieldd.GnarkFormal.RvkFixedBaseLadderChoiceFree
