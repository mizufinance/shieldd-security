...
@[simp] theorem nbStep_uncps
    ...
    Extracted.NetBalanceCommitment2.scalarMulStep bit ax ay cx cy k ↔
      ∃ acc' cur',
        StepRel bit ⟨ax, ay⟩ ⟨cx, cy⟩ acc' cur' ∧
        k vec![acc'.x, acc'.y, cur'.x, cur'.y] := by
  simp only [Extracted.NetBalanceCommitment2.scalarMulStep, StepRel, EdwardsBridge.addSpec,
    EdwardsBridge.doubleSpec, EdwardsBridge.a, EdwardsBridge.d,
    Extracted.NetBalanceCommitment2.Gates, GatesGnark9, GatesGnark8, GatesDef.mul, GatesDef.add,
...
def nbLadderK {n : ℕ} (bits : List.Vector F n) (k : List.Vector F 4 → Prop) :
  ...
  | fuel + 1, bitIndex, acc, cur =>
      Extracted.NetBalanceCommitment2.scalarMulStep bits[bitIndex]! acc.x acc.y cur.x cur.y
        (fun state =>
...
def nbAddK (px py qx qy : F) (k : F → F → Prop) : Prop :=
    ∃g0, g0 = Extracted.NetBalanceCommitment2.Gates.mul px (8444461749428370424248824938781546531375899335154063827935233455917409239040:F) ∧
    ∃g1, g1 = Extracted.NetBalanceCommitment2.Gates.sub py g0 ∧
    ∃g2, g2 = Extracted.NetBalanceCommitment2.Gates.add qx qy ∧
    ∃g3, g3 = Extracted.NetBalanceCommitment2.Gates.mul g1 g2 ∧
    ∃g4, g4 = Extracted.NetBalanceCommitment2.Gates.mul qy px ∧
    ∃g5, g5 = Extracted.NetBalanceCommitment2.Gates.mul qx py ∧
    ∃g6, g6 = Extracted.NetBalanceCommitment2.Gates.mul (3021:F) g4 ∧
    ∃g7, g7 = Extracted.NetBalanceCommitment2.Gates.mul g6 g5 ∧
    ∃g8, g8 = Extracted.NetBalanceCommitment2.Gates.add g4 g5 ∧
    ∃g9, g9 = Extracted.NetBalanceCommitment2.Gates.add (1:F) g7 ∧
    ∃g10, g10 = Extracted.NetBalanceCommitment2.Gates.mul (8444461749428370424248824938781546531375899335154063827935233455917409239040:F) g4 ∧
    ∃g11, g11 = Extracted.NetBalanceCommitment2.Gates.sub g10 g5 ∧
    ∃g12, g12 = Extracted.NetBalanceCommitment2.Gates.add g11 g3 ∧
    ∃g13, g13 = Extracted.NetBalanceCommitment2.Gates.sub (1:F) g7 ∧
    ∃rx, Extracted.NetBalanceCommitment2.Gates.div_unchecked g8 g9 rx ∧
    ∃ry, Extracted.NetBalanceCommitment2.Gates.div_unchecked g12 g13 ry ∧
    k rx ry
...
theorem nbAddK_semantic (px py qx qy : F) (k : F → F → Prop)
  ...
  simp only [nbAddK, EdwardsBridge.addSpec, EdwardsBridge.a, EdwardsBridge.d,
    Extracted.NetBalanceCommitment2.Gates, GatesGnark9, GatesGnark8, GatesDef.mul,
...
def nbFinalK (px py qx qy outX outY : F) : Prop :=
    ...
    ∃rx, Extracted.NetBalanceCommitment2.Gates.div_unchecked g8 g9 rx ∧
    ∃ry, Extracted.NetBalanceCommitment2.Gates.div_unchecked g12 g13 ry ∧
    Extracted.NetBalanceCommitment2.Gates.eq rx outX ∧
    Extracted.NetBalanceCommitment2.Gates.eq ry outY ∧
    ∃g14, g14 = Extracted.NetBalanceCommitment2.Gates.mul outX outX ∧
    ∃g15, g15 = Extracted.NetBalanceCommitment2.Gates.mul outY outY ∧
    ∃g16, g16 = Extracted.NetBalanceCommitment2.Gates.sub g15 g14 ∧
    ∃g17, g17 = Extracted.NetBalanceCommitment2.Gates.mul (3021:F) g14 ∧
    ∃g18, g18 = Extracted.NetBalanceCommitment2.Gates.mul g17 g15 ∧
    ∃g19, g19 = Extracted.NetBalanceCommitment2.Gates.add (1:F) g18 ∧
    Extracted.NetBalanceCommitment2.Gates.eq g16 g19 ∧
    True
...
def nbBody (vgX vgY in0 in1 outp0 outp1 blind outX outY : F) : Prop :=
  ∃ b1, Extracted.NetBalanceCommitment2.Gates.to_binary in0 128 b1 ∧
  nbLadderK b1 (fun s1 =>
  ∃ b2, Extracted.NetBalanceCommitment2.Gates.to_binary in1 128 b2 ∧
  nbLadderK b2 (fun s2 =>
  ∃ b3, Extracted.NetBalanceCommitment2.Gates.to_binary outp0 128 b3 ∧
  nbLadderK b3 (fun s3 =>
  ∃ b3b, Extracted.NetBalanceCommitment2.Gates.to_binary outp1 128 b3b ∧
  nbLadderK b3b (fun s3b =>
    nbAddK (0:F) (1:F) s1[0] s1[1] (fun a1x a1y =>
    nbAddK a1x a1y s2[0] s2[1] (fun a2x a2y =>
    ∃ g621, g621 = Extracted.NetBalanceCommitment2.Gates.neg s3[0] ∧
    nbAddK a2x a2y g621 s3[1] (fun a3x a3y =>
    ∃ g621b, g621b = Extracted.NetBalanceCommitment2.Gates.neg s3b[0] ∧
    nbAddK a3x a3y g621b s3b[1] (fun a4x a4y =>
    ∃ b4, Extracted.NetBalanceCommitment2.Gates.to_binary blind 251 b4 ∧
    nbLadderK b4 (fun s4 =>
    nbFinalK a4x a4y s4[0] s4[1] outX outY)
      251 0 ⟨0, 1⟩
      ⟨(4661681602708190761543544705274244814260880986867766715334030151044279151219 : F),
...
theorem nb_circuit_eq
    ...
    Extracted.NetBalanceCommitment2.circuit Input0Amount Input1Amount Output0Amount Output1Amount
      ...
      Extracted.PoseidonHash1.poseidonPerm1
        ...
        nbBody vgX vgY Input0Amount Input1Amount Output0Amount Output1Amount BalanceBlinding OutX OutY := by
  unfold Extracted.NetBalanceCommitment2.circuit encodeSeg0 nbEncodeSeg1K nbBody
    nbLadderK nbAddK nbFinalK
  simp (config := { maxSteps := 4000000 }) only [Extracted.NetBalanceCommitment2.Gates,
...
theorem nbLadder {nBits : ℕ} {scalar : F} {base : EdwardsBridge.Point}
  ...
  simp only [Extracted.NetBalanceCommitment2.Gates, GatesGnark9, GatesGnark8] at hbin
...
private theorem nb_circuit_eq_and_onCurve
  ...
  -- identity seed (constant net-balance seed ladder eliminated) + four value ladders
  ...
  have hg621' : g621 = -P3.x := by
    rw [hg621]
    simp only [Extracted.NetBalanceCommitment2.Gates, GatesGnark9, GatesGnark8, GatesDef.neg,
      mul_neg_one, neg_inj]
    rfl
  ...
  have hg621b' : g621b = -P3b.x := by
    rw [hg621b]
    simp only [Extracted.NetBalanceCommitment2.Gates, GatesGnark9, GatesGnark8, GatesDef.neg,
      mul_neg_one, neg_inj]
    rfl
  have hnegEqb : EdwardsBridge.negF P3b = ⟨g621b, P3b.y⟩ := by
    rw [hg621b']; rfl
  have hnegP3bon : EdwardsBridge.onCurve ⟨g621b, P3b.y⟩ :=
    hnegEqb ▸ EdwardsBridge.neg_onCurve P3b hP3bon
  have hA4 := EdwardsBridge.addSpec_eq ⟨a3x, a3y⟩ ⟨g621b, P3b.y⟩ ⟨a4x, a4y⟩ hA3on hnegP3bon haddD
  have hA4on : EdwardsBridge.onCurve ⟨a4x, a4y⟩ :=
    hA4 ▸ EdwardsBridge.add_onCurve _ _ hA3on hnegP3bon
  ...
  show (⟨OutX, OutY⟩ : Decaf377Assumptions.Point) =
    Decaf377Assumptions.netBalanceCommit2 _ _ _ _ _ _
  have hgoal : (⟨OutX, OutY⟩ : Decaf377Assumptions.Point) = toA ⟨OutX, OutY⟩ := rfl
  rw [hgoal, hOut, toA_addF, hA4, toA_addF, hnegEqb.symm, toA_negF, hA3, toA_addF, hnegEq.symm,
    toA_negF, hA2, toA_addF, hA1, toA_addF, hS0eq, hP1eq, hP2eq, hP3eq, hP3beq, hP4eq, hbg]
  simp only [Decaf377Assumptions.netBalanceCommit2, Decaf377Assumptions.valueGeneratorDomain,
    hvgEq, toA]
...
theorem decaf377_netBalanceCommitment2_sound
    (input0 input1 output0 output1 assetID balanceBlinding : F) (out : Decaf377Assumptions.Point)
    (h : Decaf377Assumptions.NetBalanceCommitment2Circuit
      input0 input1 output0 output1 assetID balanceBlinding out) :
    Decaf377Assumptions.NetBalanceCommitment2Spec
      input0 input1 output0 output1 assetID balanceBlinding out := by
  obtain ⟨ews, einv, hcircuit⟩ := h
  have hsound := nb_circuit_sound input0 input1 output0 output1 assetID balanceBlinding
    ews einv out.x out.y hcircuit
  show out = Decaf377Assumptions.netBalanceCommit2 input0 input1 output0 output1 assetID balanceBlinding
  cases out; exact hsound

/-- `Decaf377Assumptions` predicate-level on-curve wrapper. -/
theorem decaf377_netBalanceCommitment2_onCurve
    (input0 input1 output0 output1 assetID balanceBlinding : F) (out : Decaf377Assumptions.Point)
    (h : Decaf377Assumptions.NetBalanceCommitment2Circuit
      input0 input1 output0 output1 assetID balanceBlinding out) :
