...
namespace Shieldd.GnarkFormal.Deployed.Contracts.ShieldedIcs20Withdrawal.Seg3

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 298, 21]
...
segmentIndex := 3,
relationSha256Hex := "4f336df0fb0f15b4c671db00611655d993d10aa5d9492ec5b1a82c8d88c8ca14",
wireRoleSha256Hex := "c02bc008cd8ee3a1725fac0038f25a1cba81a9f0afa73aeff288a1ee3edd4ed0",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.ShieldedIcs20Withdrawal.Seg3
