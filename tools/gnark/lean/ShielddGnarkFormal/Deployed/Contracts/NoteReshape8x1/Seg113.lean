...
namespace Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg113

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 473, 550, 89060]
...
segmentIndex := 113,
relationSha256Hex := "49053ae3c44f047173c03f13dadbab71cc98127a6d6a483bf7efdb34438ade26",
wireRoleSha256Hex := "1fc012e37c891f0223ab3f24b0390ab5e29f5c9e8bfec66982813dce7dc1d709",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg113
