...
namespace Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg52

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 218, 38682, 139, 38684, 138, 38683, 38685, 38686, 38687]
...
segmentIndex := 52,
relationSha256Hex := "f45bc24423fb64fb32d4a5aed79206e1752935bd1128b0c38d3944a1b0a6f200",
wireRoleSha256Hex := "5fe3e44fe769a4c7dcd068f49ddfe028d2706f0ca1ddd111c64f702de941c1b1",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg52
