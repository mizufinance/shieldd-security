...
namespace Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg128

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 556, 633, 101653]
...
segmentIndex := 128,
relationSha256Hex := "1aa76fd0ea5c151ff115c18f092673095ccf4b2f55380d8e47f626536249cb4d",
wireRoleSha256Hex := "2f936fc3d27a7aee1649aedabc4d1285b47c589f0d0292b3d2c4be9800391547",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg128
