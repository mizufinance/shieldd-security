...
namespace Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg143

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 639, 716, 114246]
...
segmentIndex := 143,
relationSha256Hex := "8dc0dd2f1bed68edc2cb06fc36e86ceaf2798c776c4da06815d447c5d184ffd9",
wireRoleSha256Hex := "2cb5f8d1a2ba646c70f509fb5ac556f59ef9845c2d0ccd2b75a07a65cc421385",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg143
