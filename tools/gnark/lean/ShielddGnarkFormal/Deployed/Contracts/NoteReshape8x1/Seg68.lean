...
namespace Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg68

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 224, 301, 51281]
...
segmentIndex := 68,
relationSha256Hex := "43de68f6506a83c3a92bb62fca1b474340fb7b1081df9006d83bfb31dc6cb54e",
wireRoleSha256Hex := "6bf24e98a6cffc4da094eee5a7792cb49d8a06b70d6f2d20c89d96770b52f148",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg68
