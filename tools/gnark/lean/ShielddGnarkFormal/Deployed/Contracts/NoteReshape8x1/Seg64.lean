...
namespace Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg64

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 301, 40224, 40229, 40234, 40239, 49464, 49448, 49453, 49458, 49463, 49465]
...
segmentIndex := 64,
relationSha256Hex := "bc91d7da1561e4a587e6cc249ad739e7c8168b6f4aa1b2bf5578ed040ce4ead2",
wireRoleSha256Hex := "a349fcc14cfd1d9c3e6f6bfc8bba677a8febbc8dbe8b5c90a503d93b8e509104",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg64
