...
namespace Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg47

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 218, 7, 36544, 36549, 36554, 36559, 36564, 36565]
...
segmentIndex := 47,
relationSha256Hex := "258517bce58803c814cb11a7beda90dec740daa3a9a10b05f3ac1c9ebd1d942c",
wireRoleSha256Hex := "300c00bc592bc6d8c93249ac0baebb3b6d7d2d059d63eb8162ac8a0a78642de1",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg47
