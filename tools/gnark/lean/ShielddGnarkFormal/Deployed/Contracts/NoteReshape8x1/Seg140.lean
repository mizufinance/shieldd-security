...
namespace Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg140

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 635, 112429, 112430]
...
segmentIndex := 140,
relationSha256Hex := "b69b45f880ebe469a55589e8db44511e1d06cb75d49de819f6cd97caede57d5f",
wireRoleSha256Hex := "90f9eab05ec59a06407a2277ff92252cb0cc2522c403e8080f00e9c198a05877",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg140
