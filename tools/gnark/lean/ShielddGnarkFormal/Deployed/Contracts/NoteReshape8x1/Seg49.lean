...
namespace Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg49

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 218, 27631, 27636, 27641, 27646, 36871, 36855, 36860, 36865, 36870, 36872]
...
segmentIndex := 49,
relationSha256Hex := "e842487dbf93dc1350c5edd9eca6ba302708cf67a5db0a57009cbd3ec7aac9db",
wireRoleSha256Hex := "2997bfb77b3f4d0ee779f150de9a06092c64385e8dd69abf370eba883fe79f83",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg49
