...
namespace Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg137

def Order : Nat := 8444461749428370424248824938781546531375899335154063827935233455917409239041
abbrev F := ZMod Order

def wireSeatingTable : List Nat := [0, 716, 7, 112102, 112107, 112112, 112117, 112122, 112123]
...
segmentIndex := 137,
relationSha256Hex := "a5d01e3850d6e7817e41b234deb02a2580c3de34a3228a4acee17a870b61a7d4",
wireRoleSha256Hex := "20a8abb0e104942d3e384d6108d42e50554a8159f8306e8e41697b3a698d7da9",
relation := relation,
spec := spec
}

end Shieldd.GnarkFormal.Deployed.Contracts.NoteReshape8x1.Seg137
