...
def wireSeatingTable : List Nat := [0, 128054, 128059, 128064, 128069, 128074, 128079, 801]
...
segmentIndex := 164,
relationSha256Hex := "a5f81e7adc1a2eacbdddd2ce63d9c5c2731f5829d44accab338c94a96160a16c",
wireRoleSha256Hex := "ce9848e8b297a17d10d91a3ee40e8f38ce55fffa4d79d05a854d8bd11d72baff",
relation := relation,
spec := spec
}
