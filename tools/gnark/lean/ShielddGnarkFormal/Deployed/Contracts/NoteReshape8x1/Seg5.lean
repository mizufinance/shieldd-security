...
def wireSeatingTable : List Nat := [0, 550]
...
segmentIndex := 5,
relationSha256Hex := "e8413e3a33e1356da81622c71016fd4a85bd1bc81eace0fc2e1eb0e1e6c327d2",
wireRoleSha256Hex := "931045b1e03c0003b5cb57c24d0a2bfef09a35c8dc78fcc0e167dd3d20976a15",
relation := relation,
spec := spec
}
