...
def wireSeatingTable : List Nat := [0, 144, 408]
...
segmentIndex := 115,
relationSha256Hex := "f7aca54311c2bd6a083c6428db1fd45f548ff78d19a314dc1fbc28d6e0e0a623",
wireRoleSha256Hex := "d48bbed3969ad4677a7ab6dfed4fd2f2acf7ad28b1581fda5a428ac880d6d0c8",
relation := relation,
spec := spec
}
