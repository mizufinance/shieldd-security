...
def senderAckPoint (rho : Nat → DeployedF) :
  ...
  ⟨(Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.output (SenderAckValuation rho)).x,
   (Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.output (SenderAckValuation rho)).y⟩

/-- Full output of the exact receiver ACK ladder. -/
def receiverAckPoint (rho : Nat → DeployedF) :
    Protocol.Common.Point DeployedF :=
  ⟨(Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.output (ReceiverAckValuation rho)).x,
   (Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.output (ReceiverAckValuation rho)).y⟩
...
theorem senderAckSpec_of_semantic
  ...
  unfold SenderAckSemanticSpec Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.spec Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.spec at h
  have hbase :
      (⟨(Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.base (SenderAckValuation rho)).x,
        (Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.base (SenderAckValuation rho)).y⟩ :
          Protocol.Common.Point DeployedF) =
        Protocol.Transfer.Concrete.effectiveRingPk (C.action rho) := by
    rw [← effectiveRingPoint_eq_action rho semantic]
    simp [
      Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.base,
...
theorem receiverAckSpec_of_semantic
  ...
  unfold ReceiverAckSemanticSpec Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.spec Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.spec at h
  have hbase :
      (⟨(Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.base (ReceiverAckValuation rho)).x,
        (Deployed.Templates.Semantics.TDecafAck_e3974880eca25a8b5cfa17d94f28498f1dc082a93526c584816508afe0778ca1.AckSupport.base (ReceiverAckValuation rho)).y⟩ :
          Protocol.Common.Point DeployedF) =
        Protocol.Transfer.Concrete.effectiveRingPk (C.action rho) := by
    rw [← effectiveRingPoint_eq_action rho semantic]
    simp [
