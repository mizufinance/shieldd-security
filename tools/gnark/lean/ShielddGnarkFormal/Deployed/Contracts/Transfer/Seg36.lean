...
def wireSeatingTable : List Nat := [0, 175, 27989, 27994, 27999, 28004]
...
segmentIndex := 36,
relationSha256Hex := "cc18477709554c48a3a6eadd9f6702740250835753db1ef2d7caa69510b60f65",
wireRoleSha256Hex := "f3eb257c7e7733c38d82dac0b2122335ca301c59d2c4f11a541d880994455af0",
relation := relation,
spec := spec
}
