...
import ShielddGnarkFormal.Deployed.StateCommitmentPathNode18.FullTail
...
theorem spec38_eq_permSpec (sin0 : F) (sin1 : F) (sin2 : F) (sin3 : F) :
    (spec38 sin0 sin1 sin2 sin3)[1] = permSpec4 tctNode19DomainLit sin0 sin1 sin2 sin3 := by
  unfold permSpec4 tctNode19DomainLit
  rfl
