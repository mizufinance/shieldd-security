import ShielddGnarkFormal.Deployed.Templates.Relations.TDecafConservationNetBalanceCommitment_91db75453548a10bc5fde12b84038f18faa6c2619dae208f39192f046be0acc3Defs9
...
def relationRow1031 (rho : Nat -> F) : Prop :=
    ((1 : F)) * (relationLc7 rho) = ((1 : F) * rho 1032)
...
def relationLc8Part0 (rho : Nat -> F) : F :=
    (1 : F) * rho 1033 + (2 : F) * rho 1034 + (4 : F) * rho 1035 + (8 : F) * rho 1036 + (16 : F) * rho 1037 + (32 : F) * rho 1038 + (64 : F) * rho 1039 + (128 : F) * rho 1040 + (256 : F) * rho 1041 + (512 : F) * rho 1042 + (1024 : F) * rho 1043 + (2048 : F) * rho 1044 + (4096 : F) * rho 1045 + (8192 : F) * rho 1046 + (16384 : F) * rho 1047 + (32768 : F) * rho 1048 + (65536 : F) * rho 1049 + (131072 : F) * rho 1050 + (262144 : F) * rho 1051 + (524288 : F) * rho 1052 + (1048576 : F) * rho 1053 + (2097152 : F) * rho 1054 + (4194304 : F) * rho 1055 + (8388608 : F) * rho 1056 + (16777216 : F) * rho 1057 + (33554432 : F) * rho 1058 + (67108864 : F) * rho 1059 + (134217728 : F) * rho 1060 + (268435456 : F) * rho 1061 + (536870912 : F) * rho 1062 + (1073741824 : F) * rho 1063 + (2147483648 : F) * rho 1064
