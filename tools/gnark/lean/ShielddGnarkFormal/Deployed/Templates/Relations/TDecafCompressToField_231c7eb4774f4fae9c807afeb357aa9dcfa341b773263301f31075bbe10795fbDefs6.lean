import ShielddGnarkFormal.Deployed.Templates.Relations.TDecafCompressToField_231c7eb4774f4fae9c807afeb357aa9dcfa341b773263301f31075bbe10795fbDefs5
...
def relationRow688 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 516) * ((1 : F) + (-1 : F) * rho 516) = ((0 : F))

def relationRow689 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 517) * ((1 : F) + (-1 : F) * rho 517) = ((0 : F))

def relationRow690 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 518) * ((1 : F) + (-1 : F) * rho 518) = ((0 : F))

def relationRow691 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 519) * ((1 : F) + (-1 : F) * rho 519) = ((0 : F))

def relationRow692 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 520) * ((1 : F) + (-1 : F) * rho 520) = ((0 : F))

def relationRow693 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 521) * ((1 : F) + (-1 : F) * rho 521) = ((0 : F))

def relationRow694 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 522) * ((1 : F) + (-1 : F) * rho 522) = ((0 : F))
...
def relationLc1Part0 (rho : Nat -> F) : F :=
    (1 : F) * rho 366 + (2 : F) * rho 367 + (4 : F) * rho 368 + (8 : F) * rho 369 + (16 : F) * rho 370 + (32 : F) * rho 371 + (64 : F) * rho 372 + (128 : F) * rho 373 + (256 : F) * rho 374 + (512 : F) * rho 375 + (1024 : F) * rho 376 + (2048 : F) * rho 377 + (4096 : F) * rho 378 + (8192 : F) * rho 379 + (16384 : F) * rho 380 + (32768 : F) * rho 381 + (65536 : F) * rho 382 + (131072 : F) * rho 383 + (262144 : F) * rho 384 + (524288 : F) * rho 385 + (1048576 : F) * rho 386 + (2097152 : F) * rho 387 + (4194304 : F) * rho 388 + (8388608 : F) * rho 389 + (16777216 : F) * rho 390 + (33554432 : F) * rho 391 + (67108864 : F) * rho 392 + (134217728 : F) * rho 393 + (268435456 : F) * rho 394 + (536870912 : F) * rho 395 + (1073741824 : F) * rho 396 + (2147483648 : F) * rho 397

def relationLc1Part1 (rho : Nat -> F) : F :=
    (4294967296 : F) * rho 398 + (8589934592 : F) * rho 399 + (17179869184 : F) * rho 400 + (34359738368 : F) * rho 401 + (68719476736 : F) * rho 402 + (137438953472 : F) * rho 403 + (274877906944 : F) * rho 404 + (549755813888 : F) * rho 405 + (1099511627776 : F) * rho 406 + (2199023255552 : F) * rho 407 + (4398046511104 : F) * rho 408 + (8796093022208 : F) * rho 409 + (17592186044416 : F) * rho 410 + (35184372088832 : F) * rho 411 + (70368744177664 : F) * rho 412 + (140737488355328 : F) * rho 413 + (281474976710656 : F) * rho 414 + (562949953421312 : F) * rho 415 + (1125899906842624 : F) * rho 416 + (2251799813685248 : F) * rho 417 + (4503599627370496 : F) * rho 418 + (9007199254740992 : F) * rho 419 + (18014398509481984 : F) * rho 420 + (36028797018963968 : F) * rho 421 + (72057594037927936 : F) * rho 422 + (144115188075855872 : F) * rho 423 + (288230376151711744 : F) * rho 424 + (576460752303423488 : F) * rho 425 + (1152921504606846976 : F) * rho 426 + (2305843009213693952 : F) * rho 427 + (4611686018427387904 : F) * rho 428 + (9223372036854775808 : F) * rho 429

def relationLc1Part2 (rho : Nat -> F) : F :=
    (18446744073709551616 : F) * rho 430 + (36893488147419103232 : F) * rho 431 + (73786976294838206464 : F) * rho 432 + (147573952589676412928 : F) * rho 433 + (295147905179352825856 : F) * rho 434 + (590295810358705651712 : F) * rho 435 + (1180591620717411303424 : F) * rho 436 + (2361183241434822606848 : F) * rho 437 + (4722366482869645213696 : F) * rho 438 + (9444732965739290427392 : F) * rho 439 + (18889465931478580854784 : F) * rho 440 + (37778931862957161709568 : F) * rho 441 + (75557863725914323419136 : F) * rho 442 + (151115727451828646838272 : F) * rho 443 + (302231454903657293676544 : F) * rho 444 + (604462909807314587353088 : F) * rho 445 + (1208925819614629174706176 : F) * rho 446 + (2417851639229258349412352 : F) * rho 447 + (4835703278458516698824704 : F) * rho 448 + (9671406556917033397649408 : F) * rho 449 + (19342813113834066795298816 : F) * rho 450 + (38685626227668133590597632 : F) * rho 451 + (77371252455336267181195264 : F) * rho 452 + (154742504910672534362390528 : F) * rho 453 + (309485009821345068724781056 : F) * rho 454 + (618970019642690137449562112 : F) * rho 455 + (1237940039285380274899124224 : F) * rho 456 + (2475880078570760549798248448 : F) * rho 457 + (4951760157141521099596496896 : F) * rho 458 + (9903520314283042199192993792 : F) * rho 459 + (19807040628566084398385987584 : F) * rho 460 + (39614081257132168796771975168 : F) * rho 461
