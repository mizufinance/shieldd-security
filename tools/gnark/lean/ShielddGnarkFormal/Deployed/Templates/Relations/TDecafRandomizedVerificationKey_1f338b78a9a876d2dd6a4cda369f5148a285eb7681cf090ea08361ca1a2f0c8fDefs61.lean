import ShielddGnarkFormal.Deployed.Templates.Relations.TDecafRandomizedVerificationKey_1f338b78a9a876d2dd6a4cda369f5148a285eb7681cf090ea08361ca1a2f0c8fDefs60
...
def relationRow1806 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 1806) * ((1 : F) * rho 1807 + (1 : F) * rho 1808) = ((1 : F) * rho 1809)
...
def relationRow1807 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 1807) * (relationLc1555 rho) = ((1 : F) * rho 1810)
...
def relationRow1808 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 1808) * (relationLc1556 rho) = ((1 : F) * rho 1811)

def relationRow1809 (rho : Nat -> F) : Prop :=
    ((3021 : F) * rho 1810) * ((1 : F) * rho 1811) = ((1 : F) * rho 1812)

def relationRow1810 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 1813) * ((1 : F) + (1 : F) * rho 1812) = ((1 : F) * rho 1810 + (1 : F) * rho 1811)

def relationRow1811 (rho : Nat -> F) : Prop :=
    ((1 : F) * rho 1814) * ((1 : F) + (-1 : F) * rho 1812) = ((1 : F) * rho 1809 + (-1 : F) * rho 1810 + (-1 : F) * rho 1811)
