...
import ShielddGnarkFormal.Deployed.Templates.Semantics.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042cDtkLtRChunk124
...
theorem dtkRStep125Pe (rho : Nat -> F) (r2069 : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2069 rho) :
    dtkRPe125 rho = dtkRPe126 rho * (1 - rho 1108) := by
  unfold Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2069 at r2069
  unfold dtkRPe125 dtkRPe126
  linear_combination -r2069

theorem dtkRStep125 (rho : Nat -> F) (r2069 : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2069 rho) :
    dtkRPe125 rho = dtkRPe126 rho * (1 - rho 1108) ∧
    dtkRIl125 rho = dtkRIl126 rho := by
  exact ⟨dtkRStep125Pe rho r2069, rfl⟩

theorem dtk_r_chunk125 (rho : Nat -> F) (h : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relation rho) (k : Prop) (hq4 : Shieldd.GnarkFormal.Extracted.IvkModR.ltcRec (dtkIvkBits rho) Shieldd.GnarkFormal.Extracted.IvkModR.q4Bit
    ...
    Shieldd.GnarkFormal.Extracted.IvkModR.ltcRec (dtkIvkBits rho) Shieldd.GnarkFormal.Extracted.IvkModR.rBit
      (Shieldd.GnarkFormal.DtkBridge.rContK (dtkIvkBits rho) (rho 978) k) 126 (dtkRPeState rho 126) (dtkRIlState rho 126) := by
  have htail := dtk_r_chunk124 rho h k hq4
  ...
  have ht := Shieldd.GnarkFormal.Deployed.Dtk.stateTrace_span_to_ltcRec
    ...
    (dtkRPeState rho) (dtkRIlState rho) 125 1
