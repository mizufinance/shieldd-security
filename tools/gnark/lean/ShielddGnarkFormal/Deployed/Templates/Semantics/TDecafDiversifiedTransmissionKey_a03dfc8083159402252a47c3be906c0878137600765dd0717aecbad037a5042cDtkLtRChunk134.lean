...
import ShielddGnarkFormal.Deployed.Templates.Semantics.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042cDtkLtRChunk133
...
theorem dtkRStep134Pe (rho : Nat -> F) (r2058 : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2058 rho) :
    dtkRPe134 rho = dtkRPe135 rho * (1 - rho 1117) := by
  unfold Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2058 at r2058
  unfold dtkRPe134 dtkRPe135
  linear_combination -r2058

theorem dtkRStep134 (rho : Nat -> F) (r2058 : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2058 rho) :
    dtkRPe134 rho = dtkRPe135 rho * (1 - rho 1117) ∧
    dtkRIl134 rho = dtkRIl135 rho := by
  exact ⟨dtkRStep134Pe rho r2058, rfl⟩

theorem dtk_r_chunk134 (rho : Nat -> F) (h : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relation rho) (k : Prop) (hq4 : Shieldd.GnarkFormal.Extracted.IvkModR.ltcRec (dtkIvkBits rho) Shieldd.GnarkFormal.Extracted.IvkModR.q4Bit
    ...
    Shieldd.GnarkFormal.Extracted.IvkModR.ltcRec (dtkIvkBits rho) Shieldd.GnarkFormal.Extracted.IvkModR.rBit
      (Shieldd.GnarkFormal.DtkBridge.rContK (dtkIvkBits rho) (rho 978) k) 135 (dtkRPeState rho 135) (dtkRIlState rho 135) := by
  have htail := dtk_r_chunk133 rho h k hq4
  ...
  have ht := Shieldd.GnarkFormal.Deployed.Dtk.stateTrace_span_to_ltcRec
    ...
    (dtkRPeState rho) (dtkRIlState rho) 134 1
