...
namespace Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound37
...
def state37Lane0 (domain in0 in1 in2 : F) : F :=
  row4 (6333346312071277818186618704086159898531924501365547870951425091938056929281 : F) (6755569399542696339399059951025237225100719468123251062348186764733927391233 : F) (7037051457856975353540687448984622109479916112628386523279361213264507699201 : F) (7238110070938603220784707090384182741179342287274911852515914390786350776321 : F) (p17 (Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound36.state36Lane0 domain in0 in1 in2 + (6136402023627867107328780042258341451909381526863697406971910076649425863577 : F))) (p17 (Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound36.state36Lane1 domain in0 in1 in2 + (403917435174867072656735572934226709672919820691101390561081554994951410328 : F))) (p17 (Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound36.state36Lane2 domain in0 in1 in2 + (2197307939742823984581382962133936215707127960884165372495222916141872574366 : F))) (p17 (Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound36.state36Lane3 domain in0 in1 in2 + (280402617002073624427675333736860754609331352944830300201501643212477955908 : F)))
def state37Lane1 (domain in0 in1 in2 : F) : F :=
  row4 (6755569399542696339399059951025237225100719468123251062348186764733927391233 : F) (7037051457856975353540687448984622109479916112628386523279361213264507699201 : F) (7238110070938603220784707090384182741179342287274911852515914390786350776321 : F) (7388904030749824121217721821433853214953911918259805849443329273927733084161 : F) (p17 (Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound36.state36Lane0 domain in0 in1 in2 + (6136402023627867107328780042258341451909381526863697406971910076649425863577 : F))) (p17 (Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound36.state36Lane1 domain in0 in1 in2 + (403917435174867072656735572934226709672919820691101390561081554994951410328 : F))) (p17 (Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound36.state36Lane2 domain in0 in1 in2 + (2197307939742823984581382962133936215707127960884165372495222916141872574366 : F))) (p17 (Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound36.state36Lane3 domain in0 in1 in2 + (280402617002073624427675333736860754609331352944830300201501643212477955908 : F)))
def state37Lane2 (domain in0 in1 in2 : F) : F :=
...
def state37Lane3 (domain in0 in1 in2 : F) : F :=
...
theorem state_eq_trace (domain in0 in1 in2 : F) :
    vec![state37Lane0 domain in0 in1 in2, state37Lane1 domain in0 in1 in2,
      state37Lane2 domain in0 in1 in2, state37Lane3 domain in0 in1 in2] =
      Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3Trace.state37
        domain in0 in1 in2 := by
  unfold Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3Trace.state37
  rw [← Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound36.state_eq_trace]
  rfl

end Shieldd.GnarkFormal.Deployed.Templates.Semantics.Poseidon3ScalarRound37
