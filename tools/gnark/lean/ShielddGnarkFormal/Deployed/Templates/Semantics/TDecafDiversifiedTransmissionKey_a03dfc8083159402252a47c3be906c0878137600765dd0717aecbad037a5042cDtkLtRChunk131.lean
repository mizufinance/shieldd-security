...
import ShielddGnarkFormal.Deployed.Templates.Semantics.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042cDtkLtRChunk130
...
theorem dtkRStep131Pe (rho : Nat -> F) (r2061 : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2061 rho) :
    dtkRPe131 rho = dtkRPe132 rho * (1 - rho 1114) := by
  unfold Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2061 at r2061
  unfold dtkRPe131 dtkRPe132
  linear_combination -r2061

theorem dtkRStep131 (rho : Nat -> F) (r2061 : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2061 rho) :
    dtkRPe131 rho = dtkRPe132 rho * (1 - rho 1114) ∧
    dtkRIl131 rho = dtkRIl132 rho := by
  exact ⟨dtkRStep131Pe rho r2061, rfl⟩

theorem dtk_r_chunk131 (rho : Nat -> F) (h : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relation rho) (k : Prop) (hq4 : Shieldd.GnarkFormal.Extracted.IvkModR.ltcRec (dtkIvkBits rho) Shieldd.GnarkFormal.Extracted.IvkModR.q4Bit
    ...
    Shieldd.GnarkFormal.Extracted.IvkModR.ltcRec (dtkIvkBits rho) Shieldd.GnarkFormal.Extracted.IvkModR.rBit
      (Shieldd.GnarkFormal.DtkBridge.rContK (dtkIvkBits rho) (rho 978) k) 132 (dtkRPeState rho 132) (dtkRIlState rho 132) := by
  have htail := dtk_r_chunk130 rho h k hq4
  ...
  have ht := Shieldd.GnarkFormal.Deployed.Dtk.stateTrace_span_to_ltcRec
    ...
    (dtkRPeState rho) (dtkRIlState rho) 131 1
