...
import ShielddGnarkFormal.Deployed.Templates.Semantics.TDecafRandomizedVerificationKey_1f338b78a9a876d2dd6a4cda369f5148a285eb7681cf090ea08361ca1a2f0c8fRvkStep221
...
theorem rvk_steps71 (rho : Nat -> F)
    ...
    : ∀ i, 221 ≤ i → i ≤ 221 → onCurve (rvkRvkAcc rho i) →
        RvkFixedBaseLadderChoiceFree.FixedStepRel i
          (rho (1 + i)) (rvkRvkAcc rho i) (rvkRvkAcc rho (i + 1)) := by
  intro i hlo hhi hacc
  interval_cases i
  · exact rvk_step221 rho r221 r1565 r1566 r1567 r1568 r1569 r1570 r1571 r1572 hacc
