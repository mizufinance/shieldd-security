...
import ShielddGnarkFormal.Deployed.Templates.Semantics.TDecafRandomizedVerificationKey_1f338b78a9a876d2dd6a4cda369f5148a285eb7681cf090ea08361ca1a2f0c8fRvkPrefixStep44
...
theorem rvk_prefix_steps43 (rho : Nat -> F)
    ...
    : ∀ i, 44 ≤ i → i ≤ 44 → onCurve (rvkRvkAcc rho i) →
        RvkFixedBaseLadderChoiceFree.FixedStepRel i
          (rho (1 + i)) (rvkRvkAcc rho i) (rvkRvkAcc rho (i + 1)) := by
  intro i hlo hhi hacc
  interval_cases i
  · exact rvk_prefix_step44 rho r44 r467 r468 r469 r470 r471 hacc
