...
import ShielddGnarkFormal.Deployed.Templates.Semantics.TDecafRandomizedVerificationKey_1f338b78a9a876d2dd6a4cda369f5148a285eb7681cf090ea08361ca1a2f0c8fRvkPrefixStep131
...
theorem rvk_prefix_steps130 (rho : Nat -> F)
    ...
    : ∀ i, 131 ≤ i → i ≤ 131 → onCurve (rvkRvkAcc rho i) →
        RvkFixedBaseLadderChoiceFree.FixedStepRel i
          (rho (1 + i)) (rvkRvkAcc rho i) (rvkRvkAcc rho (i + 1)) := by
  intro i hlo hhi hacc
  interval_cases i
  · exact rvk_prefix_step131 rho r131 r902 r903 r904 r905 r906 hacc
