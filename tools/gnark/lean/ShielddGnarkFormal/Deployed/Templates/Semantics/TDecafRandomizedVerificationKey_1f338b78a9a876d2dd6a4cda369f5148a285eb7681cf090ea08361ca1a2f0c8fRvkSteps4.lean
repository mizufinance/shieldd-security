...
import ShielddGnarkFormal.Deployed.Templates.Semantics.TDecafRandomizedVerificationKey_1f338b78a9a876d2dd6a4cda369f5148a285eb7681cf090ea08361ca1a2f0c8fRvkStep154
...
theorem rvk_steps4 (rho : Nat -> F)
    ...
    : ∀ i, 154 ≤ i → i ≤ 154 → onCurve (rvkRvkAcc rho i) →
        RvkFixedBaseLadderChoiceFree.FixedStepRel i
          (rho (1 + i)) (rvkRvkAcc rho i) (rvkRvkAcc rho (i + 1)) := by
  intro i hlo hhi hacc
  interval_cases i
  · exact rvk_step154 rho r154 r1029 r1030 r1031 r1032 r1033 r1034 r1035 r1036 hacc
