...
import ShielddGnarkFormal.Deployed.Templates.Semantics.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042cDtkLtRChunk131
...
theorem dtkRStep132Pe (rho : Nat -> F) (r2060 : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2060 rho) :
    dtkRPe132 rho = dtkRPe133 rho * (1 - rho 1115) := by
  unfold Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2060 at r2060
  unfold dtkRPe132 dtkRPe133
  linear_combination -r2060

theorem dtkRStep132 (rho : Nat -> F) (r2060 : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow2060 rho) :
    dtkRPe132 rho = dtkRPe133 rho * (1 - rho 1115) ∧
    dtkRIl132 rho = dtkRIl133 rho := by
  exact ⟨dtkRStep132Pe rho r2060, rfl⟩

theorem dtk_r_chunk132 (rho : Nat -> F) (h : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relation rho) (k : Prop) (hq4 : Shieldd.GnarkFormal.Extracted.IvkModR.ltcRec (dtkIvkBits rho) Shieldd.GnarkFormal.Extracted.IvkModR.q4Bit
    ...
    Shieldd.GnarkFormal.Extracted.IvkModR.ltcRec (dtkIvkBits rho) Shieldd.GnarkFormal.Extracted.IvkModR.rBit
      (Shieldd.GnarkFormal.DtkBridge.rContK (dtkIvkBits rho) (rho 978) k) 133 (dtkRPeState rho 133) (dtkRIlState rho 133) := by
  have htail := dtk_r_chunk131 rho h k hq4
  ...
  have ht := Shieldd.GnarkFormal.Deployed.Dtk.stateTrace_span_to_ltcRec
    ...
    (dtkRPeState rho) (dtkRIlState rho) 132 1
