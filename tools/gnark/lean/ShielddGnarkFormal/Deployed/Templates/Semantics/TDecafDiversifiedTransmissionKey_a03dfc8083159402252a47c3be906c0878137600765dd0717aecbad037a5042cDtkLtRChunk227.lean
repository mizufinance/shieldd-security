...
import ShielddGnarkFormal.Deployed.Templates.Semantics.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042cDtkLtRChunk226
...
theorem dtkRStep227Pe (rho : Nat -> F) (r1875 : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow1875 rho) :
    dtkRPe227 rho = dtkRPe228 rho * (1 - rho 1210) := by
  unfold Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow1875 at r1875
  unfold dtkRPe227 dtkRPe228
  linear_combination -r1875

theorem dtkRStep227 (rho : Nat -> F) (r1875 : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relationRow1875 rho) :
    dtkRPe227 rho = dtkRPe228 rho * (1 - rho 1210) ∧
    dtkRIl227 rho = dtkRIl228 rho := by
  exact ⟨dtkRStep227Pe rho r1875, rfl⟩

theorem dtk_r_chunk227 (rho : Nat -> F) (h : Shieldd.GnarkFormal.Deployed.Templates.Relations.TDecafDiversifiedTransmissionKey_a03dfc8083159402252a47c3be906c0878137600765dd0717aecbad037a5042c.relation rho) (k : Prop) (hq4 : Shieldd.GnarkFormal.Extracted.IvkModR.ltcRec (dtkIvkBits rho) Shieldd.GnarkFormal.Extracted.IvkModR.q4Bit
    ...
    Shieldd.GnarkFormal.Extracted.IvkModR.ltcRec (dtkIvkBits rho) Shieldd.GnarkFormal.Extracted.IvkModR.rBit
      (Shieldd.GnarkFormal.DtkBridge.rContK (dtkIvkBits rho) (rho 978) k) 228 (dtkRPeState rho 228) (dtkRIlState rho 228) := by
  have htail := dtk_r_chunk226 rho h k hq4
  ...
  have ht := Shieldd.GnarkFormal.Deployed.Dtk.stateTrace_span_to_ltcRec
    ...
    (dtkRPeState rho) (dtkRIlState rho) 227 1
