...
import ShielddGnarkFormal.Deployed.Templates.Semantics.TDecafRandomizedVerificationKey_1f338b78a9a876d2dd6a4cda369f5148a285eb7681cf090ea08361ca1a2f0c8fRvkPrefixStep73
...
theorem rvk_prefix_steps72 (rho : Nat -> F)
    ...
    : ∀ i, 73 ≤ i → i ≤ 73 → onCurve (rvkRvkAcc rho i) →
        RvkFixedBaseLadderChoiceFree.FixedStepRel i
          (rho (1 + i)) (rvkRvkAcc rho i) (rvkRvkAcc rho (i + 1)) := by
  intro i hlo hhi hacc
  interval_cases i
  · exact rvk_prefix_step73 rho r73 r612 r613 r614 r615 r616 hacc
