...
abbrev F := Shieldd.GnarkFormal.Extracted.Deployed.GadgetStateCommitmentPathNode7350_9f6242.F

def tctNode8DomainLit : F := (545001158149490383238005163525397553024965043366546261617421270984613353344 : F)
