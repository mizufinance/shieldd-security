...
import ShielddGnarkFormal.Deployed.StateCommitmentPathNode20.FullTail
...
instance : Fact (Nat.Prime Shieldd.GnarkFormal.Extracted.PoseidonHash4.Order) :=
  inferInstanceAs (Fact (Nat.Prime Shieldd.GnarkFormal.Extracted.Deployed.GadgetStateCommitmentPathNode20350_24c6fc.Order))

theorem spec38_eq_permSpec (sin0 : F) (sin1 : F) (sin2 : F) (sin3 : F) :
    (spec38 sin0 sin1 sin2 sin3)[1] = permSpec4 tctNode21DomainLit sin0 sin1 sin2 sin3 := by
  unfold permSpec4 tctNode21DomainLit
  rfl
